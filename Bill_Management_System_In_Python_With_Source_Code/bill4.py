...
def abc():
    ...
    def total():
        ...
        db = client["BillManagement"]
        collection = db["col"]
        # Order Number
        num = random.randint(1, 1000)
        order_label["text"] = num
        document = {"Name":stu_naE.get(),"Official Email":stu_idE.get(),"Icecream": dringE.get(), "Aloo Paratha": AlooparathaE.get()
            , "Poha": Poha.get(), "Upama": upama.get(),
                    "VadaPav": vadapav.get(),
                    "Special Thali": Thali.get(),

                "Total Amount ": total}

        resul = collection.insert_one(document)
    ...
    #     num = random.randint(1, 1000)
    #     order_label["text"] = num
    #     document = {"Name": stu_naE.get(), "Official Email": stu_idE.get(), "Icecream": dringE.get(),
    #                 "Aloo Paratha": AlooparathaE.get()
    #         , "Poha": Poha.get(), "Upama": upama.get(),
    #                 "VadaPav": vadapav.get(),
    #                 "Special Thali": Thali.get(),
    #
    ...
    Save_bill = Button(frame3, text="  Save Bill  ", command=onsubmit, font="arial 15 bold", bd=8)
    ...
    sub_total: Label = Label(frame2, text="Sub Total", font="arial 12 bold", bg="#CCCCCC")
    ...
    line_total = Label(frame4, text="____________________", bg="#96C3EB", font="arial 12 bold")
    linet_total = Label(frame4, text="____________________", bg="#96C3EB", font="arial 12 bold")
    ...
    stu_id = Label(frame5, text="Email ID:", font="arial 12 bold", bg="#696969")
...
heading5 = Label(ram, text='''Welcome to VIIT canteen. So Enjoy Food delightfully.
